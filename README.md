The main objective of this repo is to analise and create a recommendation system using the [movielens dataset](https://grouplens.org/datasets/movielens/20m/).
